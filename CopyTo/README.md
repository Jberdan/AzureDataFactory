...
07.) In the left side panel, click "Manage" button then navigate to Connections then Linked Services.  
...
NOTE:  
(1) when copying the URL directly from GitHub, you need to replace blob with raw  
...
NOTE:  
(1) Make sure your required folder hierarchy and file name is entered
